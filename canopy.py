...
class CanopyClass():
    ...
    def get_contours(self, res, cv_image):
        ...
        boxes_image, contours_boxes = self.get_boxes(filtered_contours, contours_image)

        return boxes_image, filtered_contours, contours_boxes
...
if __name__ == "__main__":
    ...
    contours_image, contours, contours_boxes = can.get_contours(plant, cv_image)
